...
class PlotlyTA(PltTA):
    ...
    plot(
        ...
        fig: Optional[DataMartFigure] = None,
        symbol: Optional[str] = "",
        candles: bool = True,
        volume: bool = True,
    ) -> DataMartFigure:
    ...
    def init_plot(self, symbol: str = "", candles: bool = True) -> DataMartFigure:
        ...
        """
        fig = DataMartFigure(charting_settings=self.charting_settings)
    ...
    def process_fig(self, fig: DataMartFigure, volume_ticks_x: int = 7) -> DataMartFigure:
        ...
        """
        new_subplot = DataMartFigure(charting_settings=self.charting_settings)
