...
class Volume(PltTA):
    ...
    @indicator()
    def plot_ad(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_adosc(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_obv(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
