...
import pandas as pd
from datamart_core.app.model.charts.chart import ChartFormat
from datamart_core.app.utils import basemodel_to_df

from datamart_charting.core.chart_style import ChartStyle
from datamart_charting.core.datamart_figure import DataMartFigure
from datamart_charting.core.plotly_ta.ta_class import PlotlyTA
from datamart_charting.query_params import (
...
# from .core.datamart_figure_table import DataMartFigureTable


def equity_price_historical(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
    """Equity price chart."""
...
def technical_zlma(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
    """Zero lag moving average chart."""
    ma_type = "zlma"
    return _ta_ma(ma_type, **kwargs)


def technical_aroon(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
    """Aroon chart."""
    data = basemodel_to_df(kwargs["obbject_item"], index=kwargs.get("index", "date"))
...
def technical_sma(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
    """Plot simple moving average chart."""
    ma_type = "sma"
    return _ta_ma(ma_type, **kwargs)


def technical_macd(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
...
def technical_hma(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
    """Hull moving average chart."""
    ma_type = "hma"
    return _ta_ma(ma_type, **kwargs)


def technical_adx(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
...
def technical_wma(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
    """Weighted moving average chart."""
    ma_type = "wma"
    return _ta_ma(ma_type, **kwargs)


def technical_rsi(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
...
def technical_ema(**kwargs) -> Tuple["DataMartFigure", Dict[str, Any]]:
...
) -> Tuple["DataMartFigure", Dict[str, Any]]:
...
def economy_fred_series(
    **kwargs: Union[Any, FredSeriesChartQueryParams],
    ...
    fig = DataMartFigure().create_subplots(
