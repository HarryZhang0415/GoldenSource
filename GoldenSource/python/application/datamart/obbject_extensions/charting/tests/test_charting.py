...
@patch("datamart_charting.ChartIndicators.get_available_indicators")
...
@patch("datamart_charting.get_charting_functions")
...
@patch("datamart_charting.core.backend.get_backend")
@patch("datamart_charting.core.backend.create_backend")
...
@patch("datamart_charting.charting_router")
...
@patch("datamart_charting.Charting._get_chart_function")
...
@patch("datamart_charting.to_chart")
