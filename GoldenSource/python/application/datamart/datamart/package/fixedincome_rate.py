...
class ROUTER_fixedincome_rate(Container):
    ...
    def ameribor(
        ...
        **kwargs
        ...
        >>> market.fixedincome.rate.ameribor(provider='fred')
        >>> market.fixedincome.rate.ameribor(parameter='30_day_ma', provider='fred')
        """  # noqa: E501
    ...
    def dpcredit(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.rate.dpcredit(provider='fred')
        >>> market.fixedincome.rate.dpcredit(start_date='2023-02-01', end_date='2023-05-01', provider='fred')
        """  # noqa: E501
    ...
    def ecb(
        ...
        interest_rate_type: Annotated[
            ...
            GoldenSourceCustomParameter(description="The type of interest rate."),
        ] = "lending",
        provider: Annotated[
            Optional[Literal["fred"]],
            GoldenSourceCustomParameter(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.rate.ecb(provider='fred')
        >>> market.fixedincome.rate.ecb(interest_rate_type='refinancing', provider='fred')
        """  # noqa: E501
    ...
    def effr(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.rate.effr(provider='fred')
        >>> market.fixedincome.rate.effr(parameter='daily', provider='fred')
        """  # noqa: E501
    ...
    def effr_forecast(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.rate.effr_forecast(provider='fred')
        >>> market.fixedincome.rate.effr_forecast(long_run=True, provider='fred')
        """  # noqa: E501
    ...
    def estr(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.rate.estr(provider='fred')
        >>> market.fixedincome.rate.estr(parameter='number_of_active_banks', provider='fred')
        """  # noqa: E501
    ...
    def iorb(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.rate.iorb(provider='fred')
        """  # noqa: E501
    ...
    def sonia(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.rate.sonia(provider='fred')
        >>> market.fixedincome.rate.sonia(parameter='total_nominal_value', provider='fred')
        """  # noqa: E501
