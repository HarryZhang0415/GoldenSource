...
class ROUTER_regulators_sec(Container):
    ...
    def cik_map(
        ...
        **kwargs
        ...
        >>> market.regulators.sec.cik_map(symbol='MSFT', provider='sec')
        """  # noqa: E501
    ...
    def institutions_search(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.regulators.sec.institutions_search(provider='sec')
        >>> market.regulators.sec.institutions_search(query='blackstone real estate', provider='sec')
        """  # noqa: E501
    ...
    def rss_litigation(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.regulators.sec.rss_litigation(provider='sec')
        """  # noqa: E501
    ...
    def schema_files(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.regulators.sec.schema_files(provider='sec')
        >>> # Get a list of schema files.
        >>> data = market.regulators.sec.schema_files().results
        >>> data.files[0]
        ...
        >>> market.regulators.sec.schema_files(url=url).results.files
    ...
    def sic_search(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.regulators.sec.sic_search(provider='sec')
        >>> market.regulators.sec.sic_search(query='real estate investment trusts', provider='sec')
        """  # noqa: E501
    ...
    def symbol_map(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.regulators.sec.symbol_map(query='0000789019', provider='sec')
        """  # noqa: E501
