...
class ROUTER_equity_compare(Container):
    ...
    def groups(
        ...
        **kwargs
        ...
        >>> market.equity.compare.groups(provider='finviz')
        >>> # Group by sector and analyze valuation.
        >>> market.equity.compare.groups(group='sector', metric='valuation', provider='finviz')
        >>> # Group by industry and analyze performance.
        >>> market.equity.compare.groups(group='industry', metric='performance', provider='finviz')
        >>> # Group by country and analyze valuation.
        >>> market.equity.compare.groups(group='country', metric='valuation', provider='finviz')
        """  # noqa: E501
