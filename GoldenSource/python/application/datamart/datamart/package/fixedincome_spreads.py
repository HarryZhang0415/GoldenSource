...
class ROUTER_fixedincome_spreads(Container):
    ...
    def tcm(
        ...
        **kwargs
        ...
        >>> market.fixedincome.spreads.tcm(provider='fred')
        >>> market.fixedincome.spreads.tcm(maturity='2y', provider='fred')
        """  # noqa: E501
    ...
    def tcm_effr(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.spreads.tcm_effr(provider='fred')
        >>> market.fixedincome.spreads.tcm_effr(maturity='10y', provider='fred')
        """  # noqa: E501
    ...
    def treasury_effr(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.spreads.treasury_effr(provider='fred')
        >>> market.fixedincome.spreads.treasury_effr(maturity='6m', provider='fred')
        """  # noqa: E501
