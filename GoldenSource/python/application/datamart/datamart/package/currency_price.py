...
class ROUTER_currency_price(Container):
    ...
    def historical(
        ...
        **kwargs
        ...
        >>> market.currency.price.historical(symbol='EURUSD', provider='fmp')
        >>> # Filter historical data with specific start and end date.
        >>> market.currency.price.historical(symbol='EURUSD', start_date='2023-01-01', end_date='2023-12-31', provider='fmp')
        >>> # Get data with different granularity.
        >>> market.currency.price.historical(symbol='EURUSD', provider='polygon', interval='15m')
        """  # noqa: E501
