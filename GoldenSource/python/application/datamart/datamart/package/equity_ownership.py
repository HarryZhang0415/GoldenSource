...
class ROUTER_equity_ownership(Container):
    ...
    def form_13f(
        ...
        **kwargs
        ...
        >>> market.equity.ownership.form_13f(symbol='NVDA', provider='sec')
        >>> # Enter a date (calendar quarter ending) for a specific report.
        >>> market.equity.ownership.form_13f(symbol='BRK-A', date='2016-09-30', provider='sec')
        >>> # Example finding Michael Burry's filings.
        >>> cik = market.regulators.sec.institutions_search("Scion Asset Management").results[0].cik
        >>> # Use the `limit` parameter to return N number of reports from the most recent.
        >>> market.equity.ownership.form_13f(cik, limit=2).to_df()
        """  # noqa: E501
    ...
    def insider_trading(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.ownership.insider_trading(symbol='AAPL', provider='fmp')
        >>> market.equity.ownership.insider_trading(symbol='AAPL', limit=500, provider='intrinio')
        """  # noqa: E501
    ...
    def institutional(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.ownership.institutional(symbol='AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def major_holders(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.ownership.major_holders(symbol='AAPL', provider='fmp')
        >>> market.equity.ownership.major_holders(symbol='AAPL', page=0, provider='fmp')
        """  # noqa: E501
    ...
    def share_statistics(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.ownership.share_statistics(symbol='AAPL', provider='fmp')
        """  # noqa: E501
