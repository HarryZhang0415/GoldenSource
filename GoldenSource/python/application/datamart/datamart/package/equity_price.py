...
class ROUTER_equity_price(Container):
    ...
    def historical(
        ...
        **kwargs
        ...
        >>> market.equity.price.historical(symbol='AAPL', provider='fmp')
        >>> market.equity.price.historical(symbol='AAPL', interval='1d', provider='intrinio')
        """  # noqa: E501
    ...
    def nbbo(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.price.nbbo(symbol='AAPL', provider='polygon')
        """  # noqa: E501
    ...
    def performance(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.price.performance(symbol='AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def quote(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.price.quote(symbol='AAPL', provider='fmp')
        """  # noqa: E501
