...
def test_fixedincome_government_treasury_rates(params, headers):
    ...
    url = (
        f"http://localhost:8001/api/v1/fixedincome/government/treasury_rates?{query_str}"
    )
...
def test_fixedincome_government_us_yield_curve(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/fixedincome/government/us_yield_curve?{query_str}"
    )
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_sofr(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/sofr?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_estr(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/estr?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_sonia(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/sonia?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_ameribor(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/ameribor?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_effr(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/effr?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_effr_forecast(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/effr_forecast?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_iorb(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/iorb?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_dpcredit(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/dpcredit?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_rate_ecb(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/rate/ecb?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_corporate_ice_bofa(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/corporate/ice_bofa?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_corporate_moody(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/corporate/moody?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_corporate_commercial_paper(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/fixedincome/corporate/commercial_paper?{query_str}"
    )
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_corporate_spot_rates(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/corporate/spot_rates?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_corporate_hqm(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/corporate/hqm?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_spreads_tcm(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/spreads/tcm?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_spreads_tcm_effr(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/spreads/tcm_effr?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_spreads_treasury_effr(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/spreads/treasury_effr?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_government_eu_yield_curve(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/fixedincome/government/eu_yield_curve?{query_str}"
    )
...
def test_fixedincome_government_treasury_auctions(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/government/treasury_auctions?{query_str}"
    result = requests.get(url, headers=headers, timeout=30)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_government_treasury_prices(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/fixedincome/government/treasury_prices?{query_str}"
    )
    result = requests.get(url, headers=headers, timeout=30)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_fixedincome_corporate_bond_prices(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/fixedincome/corporate/bond_prices?{query_str}"
    result = requests.get(url, headers=headers, timeout=30)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
