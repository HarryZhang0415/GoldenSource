...
from datamart_core.provider.utils.helpers import get_querystring
...
def test_equity_fundamental_balance(params, headers):
    ...
    url = f"http://localhost:8001/api/v1/equity/fundamental/balance?{query_str}"
...
def test_equity_fundamental_balance_growth(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/balance_growth?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_calendar_dividend(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/calendar/dividend?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_calendar_splits(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/calendar/splits?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_calendar_earnings(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/calendar/earnings?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_cash(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/cash?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_cash_growth(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/cash_growth?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_management_compensation(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/management_compensation?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_historical_splits(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/historical_splits?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_dividends(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/dividends?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_employee_count(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/employee_count?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_estimates_historical(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/estimates/historical?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_income(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/income?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_income_growth(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/income_growth?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_ownership_insider_trading(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/ownership/insider_trading?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_ownership_institutional(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/ownership/institutional?{query_str}"
...
def test_equity_calendar_ipo(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/calendar/ipo?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_metrics(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/metrics?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_management(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/management?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_overview(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/overview?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_ownership_major_holders(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/ownership/major_holders?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_estimates_price_target(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/estimates/price_target?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_estimates_analyst_search(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/estimates/analyst_search?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_estimates_consensus(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/estimates/consensus?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_ratios(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/ratios?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_revenue_per_geography(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/revenue_per_geography?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_revenue_per_segment(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/equity/fundamental/revenue_per_segment?{query_str}"
    )
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_filings(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/filings?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_ownership_share_statistics(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/ownership/share_statistics?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_transcript(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/transcript?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_compare_peers(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/compare/peers?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_compare_groups(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/compare/groups?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_multiples(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/multiples?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_search_attributes(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/search_attributes?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_historical_attributes(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/historical_attributes?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_latest_attributes(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/latest_attributes?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_search(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/search?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_screener(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/screener?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_price_quote(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/price/quote?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_profile(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/profile?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_gainers(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/gainers?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_losers(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/losers?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_active(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/active?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_price_performance(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/price/performance?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_undervalued_large_caps(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/undervalued_large_caps?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_undervalued_growth(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/undervalued_growth?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_aggressive_small_caps(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/equity/discovery/aggressive_small_caps?{query_str}"
    )
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_growth_tech(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/growth_tech?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_top_retail(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/top_retail?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_discovery_upcoming_release_days(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/equity/discovery/upcoming_release_days?{query_str}"
    )
...
def test_equity_discovery_filings(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/discovery/filings?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_shorts_fails_to_deliver(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/shorts/fails_to_deliver?{query_str}"
    result = requests.get(url, headers=headers, timeout=20)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_shorts_short_volume(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/shorts/short_volume?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_shorts_short_interest(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/shorts/short_interest?{query_str}"
...
def test_equity_price_nbbo(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/price/nbbo?{query_str}"
    result = requests.get(url, headers=headers, timeout=40)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_darkpool_otc(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/darkpool/otc?{query_str}"
...
def test_equity_market_snapshots(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/market_snapshots?{query_str}"
    result = requests.get(url, headers=headers, timeout=20)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_historical_eps(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/historical_eps?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_trailing_dividend_yield(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/fundamental/trailing_dividend_yield?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_fundamental_reported_financials(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/equity/fundamental/reported_financials?{query_str}"
    )
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_equity_ownership_form_13f(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/equity/ownership/form_13f?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
