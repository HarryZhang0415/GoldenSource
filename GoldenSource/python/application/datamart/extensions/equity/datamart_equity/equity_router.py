...
from datamart_core.app.model.example import APIEx
...
from datamart_equity.calendar.calendar_router import router as calendar_router
from datamart_equity.compare.compare_router import router as compare_router
from datamart_equity.darkpool.darkpool_router import router as darkpool_router
from datamart_equity.discovery.discovery_router import router as discovery_router
from datamart_equity.estimates.estimates_router import router as estimates_router
from datamart_equity.fundamental.fundamental_router import router as fundamental_router
from datamart_equity.ownership.ownership_router import router as ownership_router
from datamart_equity.price.price_router import router as price_router
from datamart_equity.shorts.shorts_router import router as shorts_router
