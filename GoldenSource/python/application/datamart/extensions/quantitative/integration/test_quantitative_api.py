...
def request_data(
    ...
    url = f"http://localhost:8001/api/v1/{menu}/price/historical?symbol={symbol}&provider={provider}&start_date={start_date}&end_date={end_date}"
...
def test_quantitative_normality(params, data_type):
    ...
    url = f"http://localhost:8001/api/v1/quantitative/normality?{query_str}"
...
def test_quantitative_capm(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/capm?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_performance_omega_ratio(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/performance/omega_ratio?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_rolling_kurtosis(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/rolling/kurtosis?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_unitroot_test(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/unitroot_test?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_performance_sharpe_ratio(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/quantitative/performance/sharpe_ratio?{query_str}"
    )
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_performance_sortino_ratio(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/quantitative/performance/sortino_ratio?{query_str}"
    )
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_rolling_skew(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/rolling/skew?{query_str}"
...
def test_quantitative_rolling_variance(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/rolling/variance?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_rolling_stdev(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/rolling/stdev?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_rolling_mean(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/rolling/mean?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_rolling_quantile(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/rolling/quantile?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_summary(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/summary?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_stats_skew(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/stats/skew?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_stats_kurtosis(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/stats/kurtosis?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_stats_mean(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/stats/mean?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_stats_stdev(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/stats/stdev?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_stats_variance(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/stats/variance?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=60, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_quantitative_stats_quantile(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/quantitative/stats/quantile?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=data)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
