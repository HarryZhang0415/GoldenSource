...
from datamart_quantitative.helpers import validate_window
    ...
    examples=[
        PythonEx(
            ...
            code=[
                ...
                'market.quantitative.performance.sortino_ratio(data=stock_data, target="close", target_return=0.01, window=126, adjusted=True)',  # noqa: E501  pylint: disable=line-too-long
            ],
        ),
        APIEx(
            parameters={
