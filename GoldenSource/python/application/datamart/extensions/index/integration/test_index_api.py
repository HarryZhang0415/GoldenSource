...
def test_index_constituents(params, headers):
    ...
    url = f"http://localhost:8001/api/v1/index/constituents?{query_str}"
...
def test_index_price_historical(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/index/price/historical?{query_str}"
...
def test_index_market(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/index/market?{query_str}"
    result = requests.get(url, headers=headers, timeout=20)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_index_available(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/index/available?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_index_search(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/index/search?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_index_snapshots(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/index/snapshots?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_index_sp500_multiples(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/index/sp500_multiples?{query_str}"
    result = requests.get(url, headers=headers, timeout=20)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_index_sectors(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/index/sectors?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
