...
from extensions.tests.utils.helpers import list_datamart_extensions
...
def parametrize(argnames: str, argvalues: List, **kwargs):
    ...
    routers, providers, obbject_ext = list_datamart_extensions()
    ...
    def decorator(function):
        ...
        extension_name = "datamart_" + name if name == "charting" else name
