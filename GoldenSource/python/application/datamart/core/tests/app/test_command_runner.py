...
from datamart_core.app.command_runner import (
    CommandRunner,
    ExecutionContext,
    ParametersBuilder,
    StaticCommandRunner,
...
from datamart_core.app.provider_interface import ExtraParams
...
def test_parameters_builder_update_provider_choices(
    ...
    with patch("datamart_core.app.command_runner.ProviderInterface") as mock_pi:
...
@patch("datamart_core.app.command_runner.LoggingService")
...
def test_command_runner_run(_):
    ...
    with patch(
        "datamart_core.app.command_runner.StaticCommandRunner",
...
@pytest.mark.asyncio
@patch("datamart_core.app.command_runner.CommandMap.get_command")
@patch("datamart_core.app.command_runner.StaticCommandRunner._execute_func")
...
@pytest.mark.asyncio
@patch("datamart_core.app.command_runner.LoggingService")
@patch("datamart_core.app.command_runner.ParametersBuilder.build")
@patch("datamart_core.app.command_runner.StaticCommandRunner._command")
@patch("datamart_core.app.command_runner.StaticCommandRunner._chart")
