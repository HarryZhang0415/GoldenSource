...
import pytest
from datamart_core.app.logs.handlers.path_tracking_file_handler import (
...
def test_clean_expired_files(handler):
    with patch(
        "datamart_core.app.logs.handlers.path_tracking_file_handler.get_expired_file_list"
    ) as mock_get_expired_file_list, patch(
        "datamart_core.app.logs.handlers.path_tracking_file_handler.remove_file_list"
