...
from datamart_core.api.auth.user import (
    UserSettings,
    authenticate_user,
    get_user_service,
    get_user_settings,
...
@patch("datamart_core.api.auth.user.Env")
@patch("datamart_core.api.auth.user.HTTPBasicCredentials")
...
@patch("datamart_core.api.auth.user.UserService")
