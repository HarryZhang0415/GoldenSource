...
from datamart_core.api.router.coverage import get_command_coverage, get_provider_coverage


@patch("datamart_core.api.router.coverage.CommandMap")
...
@patch("datamart_core.api.router.coverage.CommandMap")
@patch("datamart_core.api.router.coverage.ProviderInterface")
