...
from datamart_core.app.logs.handlers_manager import (
    HandlersManager,
...
def test_handlers_added_correctly():
    with patch(
        "datamart_core.app.logs.handlers_manager.PosthogHandler",
        MockPosthogHandler,
    ), patch(
        "datamart_core.app.logs.handlers_manager.PathTrackingFileHandler",
        MockPathTrackingFileHandler,
    ), patch(
        "datamart_core.app.logs.handlers_manager.FormatterWithExceptions",
