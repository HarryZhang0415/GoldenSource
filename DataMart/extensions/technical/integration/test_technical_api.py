...
def request_data(menu: str, symbol: str, provider: str):
    ...
    url = f"http://localhost:8001/api/v1/{menu}/price/historical?symbol={symbol}&provider={provider}"
...
def test_technical_atr(params, data_type):
    ...
    url = f"http://localhost:8001/api/v1/technical/atr?{query_str}"
...
def test_technical_fib(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/fib?{query_str}"
...
def test_technical_obv(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/obv?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_fisher(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/fisher?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_adosc(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/adosc?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_bbands(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/bbands?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_demark(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/demark?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_vwap(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/vwap?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_donchian(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/donchian?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_ichimoku(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/ichimoku?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_clenow(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/clenow?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=15, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_ad(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/ad?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_cci(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/cci?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_stoch(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/stoch?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_kc(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/kc?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_technical_cg(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/technical/cg?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
