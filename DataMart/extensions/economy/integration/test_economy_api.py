...
def test_economy_calendar(params, headers):
    ...
    url = f"http://localhost:8001/api/v1/economy/calendar?{query_str}"
...
def test_economy_cpi(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/cpi?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_risk_premium(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/risk_premium?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_gdp_forecast(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/gdp/forecast?{query_str}"
...
def test_economy_gdp_nominal(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/gdp/nominal?{query_str}"
    result = requests.get(url, headers=headers, timeout=20)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_gdp_real(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/gdp/real?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_balance_of_payments(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/balance_of_payments?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_fred_search(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/fred_search?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_money_measures(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/money_measures?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_unemployment(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/unemployment?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_composite_leading_indicator(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/composite_leading_indicator?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_short_term_interest_rate(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/short_term_interest_rate?{query_str}"
...
def test_economy_long_term_interest_rate(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/long_term_interest_rate?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_economy_fred_regional(params, headers):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/economy/fred_regional?{query_str}"
    result = requests.get(url, headers=headers, timeout=10)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
