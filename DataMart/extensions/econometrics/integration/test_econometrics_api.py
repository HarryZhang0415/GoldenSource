...
def test_econometrics_correlation_matrix(params, data_type):
    ...
    url = f"http://localhost:8001/api/v1/econometrics/correlation_matrix?{query_str}"
...
def test_econometrics_ols_regression_summary(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/econometrics/ols_regression_summary?{query_str}"
...
def test_econometrics_autocorrelation(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/econometrics/autocorrelation?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_econometrics_residual_autocorrelation(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = (
        f"http://localhost:8001/api/v1/econometrics/residual_autocorrelation?{query_str}"
    )
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_econometrics_cointegration(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/econometrics/cointegration?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_econometrics_causality(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/econometrics/causality?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
...
def test_econometrics_unit_root(params, data_type):
    ...
    query_str = get_querystring(params, [])
    url = f"http://localhost:8001/api/v1/econometrics/unit_root?{query_str}"
    result = requests.post(url, headers=get_headers(), timeout=10, data=body)
    assert isinstance(result, requests.Response)
    assert result.status_code == 200
