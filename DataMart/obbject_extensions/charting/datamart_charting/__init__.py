"""DataMart OBBject extension for charting."""
...
from datamart_core.app.model.extension import Extension
from datamart_core.app.utils import basemodel_to_df, convert_to_basemodel
from datamart_core.provider.abstract.data import Data

from datamart_charting import charting_router
from datamart_charting.core.to_chart import ChartIndicators, to_chart
from datamart_charting.utils.helpers import get_charting_functions
...
class Charting:
    ...
    def _handle_backend(self):
        # pylint: disable=import-outside-toplevel
        from datamart_charting.core.backend import create_backend, get_backend
    ...
    def to_chart(
        ...
        **kwargs,
        ...
        """
        Creates a DataMartFigure with user customizations (if any) and saves it to the OBBject.
        ...
        > from datamart_charting.core.plotly_ta.data_classes import ChartIndicators
