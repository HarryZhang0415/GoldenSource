    ...
    def apply_style(self, style: Optional[str] = "") -> None:
        ...
        if self.plt_style and self.plotly_template:
            ...
            if "tables" in self.plt_styles_available:
                ...
                pio.templates["datamart_tables"] = go.layout.Template(tables)
            try:
                pio.templates["datamart"] = go.layout.Template(self.plotly_template)
            ...
            if style in ["dark", "white"]:
                pio.templates.default = f"plotly_{style}+datamart"
                return

            pio.templates.default = "datamart"
            self.mapbox_style = (
