...
class Volatility(PltTA):
    ...
    @indicator()
    def plot_atr(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_bbands(self, fig: DataMartFigure, df_ta: pd.DataFrame, inchart_index: int):
    ...
    @indicator()
    def plot_donchian(self, fig: DataMartFigure, df_ta: pd.DataFrame, inchart_index: int):
    ...
    @indicator()
    def plot_kc(self, fig: DataMartFigure, df_ta: pd.DataFrame, inchart_index: int):
