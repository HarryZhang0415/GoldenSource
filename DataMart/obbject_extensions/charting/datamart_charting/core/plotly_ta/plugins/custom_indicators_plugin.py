...
import numpy as np
import pandas as pd
from datamart_charting.core.config.datamart_styles import PLT_FIB_COLORWAY
from datamart_charting.core.datamart_figure import DataMartFigure
from datamart_charting.core.plotly_ta.base import PltTA, indicator
...
class Custom(PltTA):
    ...
    @indicator()
    def plot_srlines(self, fig: DataMartFigure, df_ta: pd.DataFrame):
    ...
    @indicator()
    def plot_fib(self, fig: DataMartFigure, df_ta: pd.DataFrame):
