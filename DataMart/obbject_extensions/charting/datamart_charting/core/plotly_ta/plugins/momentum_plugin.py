...
from datamart_charting.core.plotly_ta.base import (
    PltTA,
    indicator,
)
from datamart_charting.core.plotly_ta.data_classes import (
    columns_regex,
)
...
class Momentum(PltTA):
    ...
    @indicator()
    def plot_cci(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_cg(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_clenow(self, fig: DataMartFigure, df_ta: pd.DataFrame, inchart_index: int):
        """Add current close price to plotly figure."""
        try:
            from datamart_technical.helpers import (  # pylint: disable=import-outside-toplevel
                clenow_momentum,
            )
        except ImportError:
            warnings.warn(
                "In order to use the Clenow momentum indicator in your plot,"
                " you need to install the `datamart-technical` package."
            )
    ...
    @indicator()
    def plot_demark(self, fig: DataMartFigure, df_ta: pd.DataFrame, inchart_index: int):
    ...
    @indicator()
    def plot_fisher(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_macd(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_rsi(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_stoch(self, fig: DataMartFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_ichimoku(self, fig: DataMartFigure, df_ta: pd.DataFrame, inchart_index: int):
