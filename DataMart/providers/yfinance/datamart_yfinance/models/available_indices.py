...
from datamart_core.provider.standard_models.available_indices import (
    AvailableIndicesData,
    AvailableIndicesQueryParams,
)
from datamart_yfinance.utils.references import INDICES
...
class YFinanceAvailableIndicesData(AvailableIndicesData):
    ...
    code: str = Field(
        description="ID code for keying the index in the DataMart Terminal."
    )
