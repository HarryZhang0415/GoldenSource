...
class ROUTER_equity(Container):
    ...
    def market_snapshots(
        ...
        **kwargs
        ...
        >>> market.equity.market_snapshots(provider='fmp')
        """  # noqa: E501
    ...
    def profile(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.profile(symbol='AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def screener(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.screener(provider='fmp')
        """  # noqa: E501
    ...
    def search(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.search(provider='intrinio')
        >>> market.equity.search(query='AAPL', is_symbol=False, use_cache=True, provider='nasdaq')
        """  # noqa: E501
