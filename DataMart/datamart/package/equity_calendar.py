...
class ROUTER_equity_calendar(Container):
    ...
    def dividend(
        ...
        **kwargs
        ...
        >>> market.equity.calendar.dividend(provider='fmp')
        >>> # Get dividend calendar for specific dates.
        >>> market.equity.calendar.dividend(start_date='2024-02-01', end_date='2024-02-07', provider='nasdaq')
        """  # noqa: E501
    ...
    def earnings(
        ...
        provider: Annotated[
            Optional[Literal["fmp", "nasdaq", "tmx"]],
            DataMartCustomParameter(
                description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default."
            ),
        ] = None,
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.calendar.earnings(provider='fmp')
        >>> # Get earnings calendar for specific dates.
        >>> market.equity.calendar.earnings(start_date='2024-02-01', end_date='2024-02-07', provider='fmp')
        """  # noqa: E501
    ...
    def ipo(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.calendar.ipo(provider='intrinio')
        >>> market.equity.calendar.ipo(limit=100, provider='nasdaq')
        >>> # Get all IPOs available.
        >>> market.equity.calendar.ipo(provider='intrinio')
        >>> # Get IPOs for specific dates.
        >>> market.equity.calendar.ipo(start_date='2024-02-01', end_date='2024-02-07', provider='nasdaq')
        """  # noqa: E501
    ...
    def splits(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.calendar.splits(provider='fmp')
        >>> # Get stock splits calendar for specific dates.
        >>> market.equity.calendar.splits(start_date='2024-02-01', end_date='2024-02-07', provider='fmp')
        """  # noqa: E501
