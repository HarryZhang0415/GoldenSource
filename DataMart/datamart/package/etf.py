...
class ROUTER_etf(Container):
    ...
    def countries(
        ...
        **kwargs
        ...
        >>> market.etf.countries(symbol='VT', provider='fmp')
        """  # noqa: E501
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={"symbol": {"multiple_items_allowed": ["fmp", "tmx"]}},
            )
        )
    ...
    def equity_exposure(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.equity_exposure(symbol='MSFT', provider='fmp')
        >>> # This function accepts multiple tickers.
        >>> market.etf.equity_exposure(symbol='MSFT,AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def historical(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.historical(symbol='SPY', provider='fmp')
        >>> market.etf.historical(symbol='SPY', provider='yfinance')
        >>> # This function accepts multiple tickers.
        >>> market.etf.historical(symbol='SPY,IWM,QQQ,DJIA', provider='yfinance')
        """  # noqa: E501
    ...
    def holdings(
        self,
        symbol: Annotated[
            str, DataMartCustomParameter(description="Symbol to get data for. (ETF)")
        ],
        provider: Annotated[
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.holdings(symbol='XLK', provider='fmp')
        >>> # Including a date (FMP, SEC) will return the holdings as per NPORT-P filings.
        >>> market.etf.holdings(symbol='XLK', date='2022-03-31', provider='fmp')
        >>> # The same data can be returned from the SEC directly.
        >>> market.etf.holdings(symbol='XLK', date='2022-03-31', provider='sec')
        """  # noqa: E501
    ...
    def holdings_date(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.holdings_date(symbol='XLK', provider='fmp')
        """  # noqa: E501
    ...
    def holdings_performance(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.holdings_performance(symbol='XLK', provider='fmp')
        """  # noqa: E501
    ...
    def info(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.info(symbol='SPY', provider='fmp')
        >>> # This function accepts multiple tickers.
        >>> market.etf.info(symbol='SPY,IWM,QQQ,DJIA', provider='fmp')
        """  # noqa: E501
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                info={
                    "symbol": {
                        "multiple_items_allowed": ["fmp", "intrinio", "tmx", "yfinance"]
                    }
                },
            )
        )
    ...
    def price_performance(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.price_performance(symbol='QQQ', provider='fmp')
        >>> market.etf.price_performance(symbol='SPY,QQQ,IWM,DJIA', provider='fmp')
        """  # noqa: E501
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={
                    "symbol": {"multiple_items_allowed": ["finviz", "fmp", "intrinio"]}
                },
            )
        )
    ...
    def search(
        ...
        **kwargs
        ...
        >>> from datamart import market
        >>> # An empty query returns the full list of ETFs from the provider.
        >>> market.etf.search(provider='fmp')
        >>> # The query will return results from text-based fields containing the term.
        >>> market.etf.search(query='commercial real estate', provider='fmp')
        """  # noqa: E501
    ...
    def sectors(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.etf.sectors(symbol='SPY', provider='fmp')
        """  # noqa: E501
