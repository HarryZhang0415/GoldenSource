...
class ROUTER_derivatives_options(Container):
    ...
    def chains(
        ...
        provider: Annotated[
            Optional[Literal["cboe", "intrinio", "tmx", "tradier"]],
        ...
        **kwargs
        ...
        provider : Optional[Literal['cboe', 'intrinio', 'tmx', 'tradier']]
        ...
        >>> market.derivatives.options.chains(symbol='AAPL', provider='intrinio')
        >>> # Use the "date" parameter to get the end-of-day-data for a specific date, where supported.
        >>> market.derivatives.options.chains(symbol='AAPL', date='2023-01-25', provider='intrinio')
        """  # noqa: E501
    ...
    def unusual(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.derivatives.options.unusual(provider='intrinio')
        >>> # Use the 'symbol' parameter to get the most recent activity for a specific symbol.
        >>> market.derivatives.options.unusual(symbol='TSLA', provider='intrinio')
        """  # noqa: E501
