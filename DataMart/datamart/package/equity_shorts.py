...
class ROUTER_equity_shorts(Container):
    ...
    def fails_to_deliver(
        ...
        **kwargs
        ...
        >>> market.equity.shorts.fails_to_deliver(symbol='AAPL', provider='sec')
        """  # noqa: E501
    ...
    def short_interest(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.shorts.short_interest(symbol='AAPL', provider='finra')
        """  # noqa: E501
    ...
    def short_volume(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.equity.shorts.short_volume(symbol='AAPL', provider='stockgrid')
        """  # noqa: E501
