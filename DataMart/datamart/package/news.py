...
class ROUTER_news(Container):
    ...
    def company(
        ...
        **kwargs
        ...
        >>> market.news.company(provider='benzinga')
        >>> market.news.company(limit=100, provider='benzinga')
        >>> # Get news on the specified dates.
        >>> market.news.company(symbol='AAPL', start_date='2024-02-01', end_date='2024-02-07', provider='intrinio')
        >>> # Display the headlines of the news.
        >>> market.news.company(symbol='AAPL', display='headline', provider='benzinga')
        >>> # Get news for multiple symbols.
        >>> market.news.company(symbol='aapl,tsla', provider='fmp')
        >>> # Get news company's ISIN.
        >>> market.news.company(symbol='NVDA', isin='US0378331005', provider='benzinga')
        """  # noqa: E501
    ...
    def world(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.news.world(provider='fmp')
        >>> market.news.world(limit=100, provider='intrinio')
        >>> # Get news on the specified dates.
        >>> market.news.world(start_date='2024-02-01', end_date='2024-02-07', provider='intrinio')
        >>> # Display the headlines of the news.
        >>> market.news.world(display='headline', provider='benzinga')
        >>> # Get news by topics.
        >>> market.news.world(topics='finance', provider='benzinga')
        >>> # Get news by source using 'tingo' as provider.
        >>> market.news.world(provider='tiingo', source='bloomberg')
        >>> # Filter aticles by term using 'biztoc' as provider.
        >>> market.news.world(provider='biztoc', term='apple')
        """  # noqa: E501
