...
class ROUTER_fixedincome_government(Container):
    ...
    def eu_yield_curve(
        ...
        **kwargs
        ...
        >>> market.fixedincome.government.eu_yield_curve(provider='ecb')
        >>> market.fixedincome.government.eu_yield_curve(yield_curve_type='spot_rate', provider='ecb')
        """  # noqa: E501
    ...
    def treasury_auctions(
        ...
        cusip: Annotated[
            Optional[str],
            DataMartCustomParameter(description="Filter securities by CUSIP."),
        ] = None,
        page_size: Annotated[
            Optional[int],
            DataMartCustomParameter(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.government.treasury_auctions(provider='government_us')
        >>> market.fixedincome.government.treasury_auctions(security_type='Bill', start_date='2022-01-01', end_date='2023-01-01', provider='government_us')
        """  # noqa: E501
    ...
    def treasury_prices(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.fixedincome.government.treasury_prices(provider='government_us')
        >>> market.fixedincome.government.treasury_prices(date='2019-02-05', provider='government_us')
        """  # noqa: E501
