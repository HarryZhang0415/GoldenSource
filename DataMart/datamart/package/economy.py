...
class ROUTER_economy(Container):
    ...
    def balance_of_payments(
        ...
        **kwargs
        ...
        >>> market.economy.balance_of_payments(provider='ecb')
        >>> market.economy.balance_of_payments(report_type='summary', provider='ecb')
        >>> # The `country` parameter will override the `report_type`.
        >>> market.economy.balance_of_payments(country='united_states', provider='ecb')
        """  # noqa: E501
    ...
    def calendar(
        ...
        **kwargs
        ...
        >>> market.economy.calendar(provider='fmp')
        >>> market.economy.calendar(provider='fmp', start_date='2020-03-01', end_date='2020-03-31')
        >>> # By default, the calendar will be forward-looking.
        >>> market.economy.calendar(provider='nasdaq')
        """  # noqa: E501
    ...
    def composite_leading_indicator(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.composite_leading_indicator(provider='oecd')
        >>> market.economy.composite_leading_indicator(country='all', provider='oecd')
        """  # noqa: E501
    ...
    def cpi(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.cpi(country='japan,china,turkey', provider='fred')
        >>> # Use the `units` parameter to define the reference period for the change in values.
        >>> market.economy.cpi(country='united_states,united_kingdom', units='growth_previous', provider='fred')
        """  # noqa: E501
    ...
    def fred_regional(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.fred_regional(symbol='NYICLAIMS', provider='fred')
        >>> # With a date, time series data is returned.
        >>> market.economy.fred_regional(symbol='NYICLAIMS', start_date='2021-01-01', end_date='2021-12-31', limit=10, provider='fred')
        """  # noqa: E501
    ...
    def fred_search(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.fred_search(provider='fred')
        """  # noqa: E501
    ...
    def fred_series(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.fred_series(symbol='NFCI', provider='fred')
        >>> # Multiple series can be passed in as a list.
        >>> market.economy.fred_series(symbol='NFCI,STLFSI4', provider='fred')
        >>> # Use the `transform` parameter to transform the data as change, log, or percent change.
        >>> market.economy.fred_series(symbol='CBBTCUSD', transform='pc1', provider='fred')
        """  # noqa: E501
    ...
    def long_term_interest_rate(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.long_term_interest_rate(provider='oecd')
        >>> market.economy.long_term_interest_rate(country='all', frequency='quarterly', provider='oecd')
        """  # noqa: E501
    ...
    def money_measures(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.money_measures(provider='federal_reserve')
        >>> market.economy.money_measures(adjusted=False, provider='federal_reserve')
        """  # noqa: E501
    ...
    def risk_premium(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.risk_premium(provider='fmp')
        """  # noqa: E501
    ...
    def short_term_interest_rate(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.short_term_interest_rate(provider='oecd')
        >>> market.economy.short_term_interest_rate(country='all', frequency='quarterly', provider='oecd')
        """  # noqa: E501
    ...
    def unemployment(
        ...
        **kwargs
        ...
        --------
        >>> from datamart import market
        >>> market.economy.unemployment(provider='oecd')
        >>> market.economy.unemployment(country='all', frequency='quarterly', provider='oecd')
        >>> # Demographics for the statistics are selected with the `age` parameter.
        >>> market.economy.unemployment(country='all', frequency='quarterly', age='25-54', provider='oecd')
        """  # noqa: E501
